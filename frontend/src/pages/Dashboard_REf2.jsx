...
// Assessment data (detailed breakdown for each framework)
...
// Consolidated assessment summary list for cards and drawer
const assessments = [
  {
    key: 'Five Ws',
  ...
  },
  {
    ...
    summaryScores: { completeness: 82, confidence: 70 },
  ...
  },
  {
    ...
    summaryScores: { completeness: 85, confidence: 70 },
  ...
  },
  {
    ...
    summaryScores: { completeness: 75, confidence: 60 },
    data: assessmentData['Market'],
  },
];

// Copilot Readiness Brief panel
const CopilotReadinessBrief = () => (
  <Paper sx={{ p: 3, mb: 4 }}>
    ...
    <Typography variant="body2" mb={2}>
      Your trial synopsis is shaping into a clear and pragmatic design. Several components show
      growing clarity, while others remain adaptable — as expected at this stage.
    </Typography>
    <Typography variant="body1" fontWeight={600}>
    ...
    <ul>
      <li>
        <Typography variant="body2">Refine eligibility criteria for target population</Typography>
      </li>
      <li>
        <Typography variant="body2">Align outcomes with stakeholder expectations</Typography>
      </li>
      <li>
        <Typography variant="body2">Map operational constraints into resource planning</Typography>
      </li>
    </ul>
    ...
    <ul>
      <li>
        <Typography variant="body2">Validate endpoints against payer/regulator needs</Typography>
      </li>
      <li>
        <Typography variant="body2">Test recruitment assumptions across geographies</Typography>
      </li>
    </ul>
  </Paper>
);

// Single assessment summary card (shows completeness and confidence meters)
const AssessmentCard = ({ item, onOpen }) => (
  <Paper
    sx={{ p: 2, height: '100%', position: 'relative', cursor: 'pointer' }}
    onClick={() => onOpen(item)}
  >
...
// Slide-out detail drawer for an assessment (opens on card click)
const AssessmentDetailDrawer = ({ item, onClose }) => (
  <Drawer
    anchor="right"
    open={!!item}
    onClose={onClose}
    PaperProps={{ sx: { width: '400px', p: 3 } }}
  >
    {item && (
      <>
...
// Custom tooltip for chart (shows scaled month, revenue, cumulative value)
...
// Diamond marker component for milestone points on chart
...
export default function Dashboard() {
  ...
  return (
    ...
    >
            ...
            >
              ...
              <XAxis
                ...
                label={{
                  ...
                  position: 'bottom',
                  offset: 0,
                  style: { fontWeight: 500, fontSize: '14px', fill: '#333333' },
                }}
                tick={{ fontSize: 12, fontWeight: 500, fill: '#333333' }}
      ...
      {/* Slide-out Detailed View Drawer */}
